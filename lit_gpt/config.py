...
tiny_LLaMA = [
    ...
    dict( # best
        org="StatNLP-research",
        name="tiny_LLaMA_3B_SSM_O2_best", # 
        block_size=2048,
        vocab_size=32000,
        padding_multiple=64,
        n_layer=26,
    ...
    dict( # softplus
        org="StatNLP-research",
        name="tiny_LLaMA_3B_SSM_O2_softplus", # 
        block_size=2048,
        vocab_size=32000,
        padding_multiple=64,
        n_layer=26,
    ...
    dict( # direct
        org="StatNLP-research",
        name="tiny_LLaMA_3B_SSM_O2_direct", # 
        block_size=2048,
        vocab_size=32000,
        padding_multiple=64,
        n_layer=26,
    ...
    dict( # LinearRNN
        ...
        n_head=12,
        n_embd=768,
        n_ssm=768, # 768, Code has only output projection, no input projection, 
        order=1,
        rotary_percentage=1.0,
        parallel_residual=False,
        bias=False,
    ...
    dict( # tiny_LLaMA_120M
        org="StatNLP-research",
        name="tiny_LLaMA_120M_Mamba", # 121,129,728
        block_size=2048,
        vocab_size=32000,
        padding_multiple=64,
        n_layer=12,
