...
class RetNetConfig(object):
    def __init__(self, **kwargs):
        ...
        self.decoder_retention_heads = kwargs.pop("decoder_retention_heads", 1)
        self.decoder_ffn_embed_dim = kwargs.pop("decoder_ffn_embed_dim", 1280)
        # self.decoder_layers = kwargs.pop("decoder_layers", 12)
        self.decoder_layers = kwargs.pop("decoder_layers", 1)
...
if __name__=="__main__":
    print("Test the config")
    print(RetNetConfig().fsdp)
