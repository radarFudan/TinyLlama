...
model_name = "tiny_LLaMA_120M_SSM_O2_softplus"
name = "tinyllama_120m_ssm_o2_softplus"
...
wandb_logger = WandbLogger(name="tiny_llama_120M_SSM_O2_softplus", id="tiny_llama_120M_SSM_O2_softplus", project="Rebuttal", offline=True)
...
def main(fabric, train_data_dir, val_data_dir, resume):
    ...
    fabric.seed_everything(3409)  # same seed for every process to init model (FSDP)
