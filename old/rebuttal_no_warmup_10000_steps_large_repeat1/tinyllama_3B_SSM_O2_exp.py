...
model_name = "tiny_LLaMA_3B_SSM_O2_exp"
name = "tinyllama_3B_ssm_o2_exp"
...
wandb_logger = WandbLogger(name="tiny_llama_3B_SSM_O2_exp", id="tiny_llama_3B_SSM_O2_exp", project="Rebuttal", offline=True)
