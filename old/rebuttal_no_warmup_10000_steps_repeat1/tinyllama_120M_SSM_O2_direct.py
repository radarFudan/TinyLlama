...
model_name = "tiny_LLaMA_120M_SSM_O2_direct"
name = "tinyllama_120m_ssm_o2_direct"
...
wandb_logger = WandbLogger(name="tiny_llama_120M_SSM_O2_direct", id="tiny_llama_120M_SSM_O2_direct", project="Rebuttal", offline=True)
