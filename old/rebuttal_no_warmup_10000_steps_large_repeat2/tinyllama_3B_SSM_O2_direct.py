...
model_name = "tiny_LLaMA_3B_SSM_O2_direct"
name = "tinyllama_3B_ssm_o2_direct"
...
wandb_logger = WandbLogger(name="tiny_llama_3B_SSM_O2_direct", id="tiny_llama_3B_SSM_O2_direct", project="Rebuttal", offline=True)
