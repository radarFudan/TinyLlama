...
wandb_logger = WandbLogger(name="tiny_llama_120M_SSM_O2_softplus", id="tiny_llama_120M_SSM_O2_softplus", project="Rebuttal")
...
def main(fabric, train_data_dir, val_data_dir, resume):
    ...
    fabric.seed_everything(3411)  # same seed for every process to init model (FSDP)
