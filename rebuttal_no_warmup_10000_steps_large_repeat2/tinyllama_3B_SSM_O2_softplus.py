...
model_name = "tiny_LLaMA_3B_SSM_O2_softplus"
name = "tinyllama_3B_ssm_o2_softplus"
...
wandb_logger = WandbLogger(name="tiny_llama_3B_SSM_O2_softplus", id="tiny_llama_3B_SSM_O2_softplus", project="Rebuttal", offline=True)
