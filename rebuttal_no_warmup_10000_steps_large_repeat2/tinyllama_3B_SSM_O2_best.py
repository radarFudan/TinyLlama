...
model_name = "tiny_LLaMA_3B_SSM_O2_best"
name = "tinyllama_3B_ssm_o2_best"
...
wandb_logger = WandbLogger(name="tiny_llama_3B_SSM_O2_best", id="tiny_llama_3B_SSM_O2_best", project="Rebuttal", offline=True)
